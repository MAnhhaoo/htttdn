...
export const UserScalarFieldEnumSchema = z.enum(['id','fullName','email','phone','password','avatar','gender','address','status','role','createdBy','createdAt','updatedAt','deletedAt']);
