...
CREATE TABLE "VariantAttributeValue" (
    ...
    CONSTRAINT "VariantAttributeValue_pkey" PRIMARY KEY ("productVariantId","attributeValueId")
);
...
-- AddForeignKey
ALTER TABLE "VariantAttributeValue" ADD CONSTRAINT "VariantAttributeValue_productVariantId_fkey" FOREIGN KEY ("productVariantId") REFERENCES "ProductVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
